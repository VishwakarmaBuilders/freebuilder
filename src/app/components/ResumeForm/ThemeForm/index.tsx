...
export const ThemeForm = () => {
  ...
  return (
    <BaseForm
      quickGuide={
        <QuickGuide text="Customize your resume's appearance by selecting a theme color, font family, font size, and document size. Choose settings that make your resume look professional and easy to read." />
      }
    >
